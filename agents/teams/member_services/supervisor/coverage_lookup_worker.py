"""
Member Services: Coverage Lookup Worker Agent
"""
...
class CoverageLookupWorker:
    ...
    def __init__(self):
        self.name = "coverage_lookup_worker"

        mcp_client = MemberServicesMCPToolClient()
        tool = mcp_client.get_tool("coverage_lookup")
        if tool is None:
            raise RuntimeError("coverage_lookup not found in MemberServicesMCPToolClient")
        self.tool = tool
