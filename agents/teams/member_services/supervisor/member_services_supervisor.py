...
2. Use EXACT worker names: member_lookup, check_eligibility, coverage_lookup.
3. If the query requires member lookup, make it goal_1.
...
{{
    "goals": [
        {{
            ...
            "priority": 1,
            "required_workers": ["member_lookup"]
        }}
    ],
    "steps": [
        {{
