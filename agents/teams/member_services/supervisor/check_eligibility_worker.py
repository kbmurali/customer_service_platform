...
WORKER_PROMPT = ( 
                    ...
                    "You MUST call the check_eligibility tool to answer — never answer from memory or context. "
        ...
        try:
            ...
            if getattr(_s, "LANGFUSE_PROMPT_VERSIONING_ENABLED", False):
                ...
                _prompt = _tracer.get_prompt_or_default(
                    "csip-member-eligibility-worker-prompt", WORKER_PROMPT, label=_label
                )
        except Exception:
